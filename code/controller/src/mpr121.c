...
#define RELEASE_THRESHOLD_BASE 50
...
bool mpr121_init(uint8_t i2c_addr) {
  ...
  // write_reg(i2c_addr, 0x7C,0x80); // Skip charge time search, use setting in
  // 0x5D,
  ...
  write_reg(i2c_addr, 0x7D, usl), write_reg(i2c_addr, 0x7E, usl * 0.65),
